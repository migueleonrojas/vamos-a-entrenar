const routes = [
   /* {
      ...
      "main_information": {
			...
			"start_date": new Date(2024, 6, 21, 8, 0, 0, 0),// [13/07/2024  8:00 a.m],
			"end_date": new Date(2024, 6, 21, 16, 0, 0, 0),//[13/07/2024  8:00 a.m]
			"meeting_point": "En la estación de Metro de Los Dos Caminos, en frente de los torniquetes."
		},
      "itinerary": [
         {
				"text": `Tomaremos una camioneta rumbo al Marqués, el costo del pasaje es de 15bs a 20bs.`,
				"sub_text": []
			},
			{
				"text": `Nos quedamos al frente del Central Madeirense y subiremos hacia la cota mil rumbo al sector La Julia.
				`,
				"sub_text": []
			},
			{
				"text": `Desde la entrada hasta el Puesto de Guarda Parques de La Julia, son máximo 30 minutos.`,
				"sub_text": []
			},
			{
				"text": `Ahí nos registramos y proseguimos a un tanque de agua que esta como a 40 minutos.`,
				"sub_text": []
			},
			{
				"text": `En el tanque podemos recargar agua, después de ahí a la próxima parada, el cual es el Mirador del Edén, son como máximo 10 minutos.
				`,
				"sub_text": []
			},
			{
				"text": `En el Mirador del Edén descansamos un tiempo prudencial, ya que viene un tramo muy dificil el cual se llama Dos Banderas, esa subida la transitaremos con cautela y sin prisa, ya que ese tramo tiene una inclinación muy considerable y esta muy expuesta al sol, se estima subir ese tramo en 2 horas como máximo.
				`,
				"sub_text": []
			},
			{
				"text": `Cuando lleguemos a la cima de Dos Banderas, tomaremos el merecido descanso.`,
				"sub_text": []
			},
			{
				"text": `Luego del descanso proseguiremos hacia una encrucijada donde tomaremos la Ruta 77 para realizar el descenso, pasaremos por Rancho Grande, el cual es un espacio plano y espacioso, seguiremos bajando hasta llegar al Edén en el cual hay una cascada muy pequeña, donde descansaremos un tiempo prudencial. Este tramo en descenso son 1 hora y 30 minutos como máximo.`,
				"sub_text": []
			},
			{
				"text": `Después de ahí regresamos al Mirador Del Edén, y posteriormente al Tanque, La Julia y al acceso de La Julia para tomar una camioneta de regreso a Los Dos Caminos; en esta partenos tardariamos como 1 hora.`,
				"sub_text": []
			},
			{
				"text": `Tiempo de duración máxima de la ruta: 7 horas.`,
				"sub_text": []
			},
      ],
      "climate_and_vegetation": {
			"climate": {
				"chance_of_rain": "El clima para la fecha convocada: 30% de probabilidades de Lluvia",
				"temperature": "Temperatura: 18º a 28º 🌡.",
				"humidity": "Humedad: 76% 💧.",
				"wind": "Viento: a 5 km/h 🌫.",
				"summary": "Chaparrones dispersos 🌧."
			},
			"vegetation": [
				{
					"text": `Primeros tramos con grados de inclinación algo considerables.`,
					"sub_text": []
				},
				{
					"text": `Tramos planos en caminos rocosos y caminos de tierra con raices, con vegetación alta que nos cubrira del sol.
					`,
					"sub_text": []
				},
				{
					"text": `En la parte más dificil de la ruta, rocas altas, escalones altos y muy consecutivos, grado de inclinación muy considerable, muy expuesto al sol, poca vegetación alta, pudiese elevarse la temperatura.
					`,
					"sub_text": []
				},
				{
					"text": `En el descenso, caminos de tierra con algunos tramos con roca suelta, tierra resbalidiza y tramos angostos cerca de acantilados.
					`,
					"sub_text": []
				}
         ]
      ...
      "important_information": [
         {
			...
			{
				"text": `Posible elevación en la temperatura.`,
				"sub_text": []
			},
      ],
      "prohibited": [
   ...
   },
   {
      ...
      "itinerary": [
         {
				"text": `Desde el Metro de Los Dos Caminos se puede tomar una camioneta que nos puede dejar en la parte alta de la Av Principal de Boleíta. (Pasaje de la camioneta 15bs a 20bs)`,
				"sub_text": []
			},
			{
				"text": `Desde el Puesto de Guarda Parques hasta Piedra del Indio se estima un tiempo máximo de 2 horas.`,
				"sub_text": []
			},
			{
				"text": `Se pudiera evaluar la idea de ir a unos pozos que quedan como a 40 minutos de piedra del indio, los cuales son:`,
				"sub_text": [
					"Los Jacuzzis",
					"Pozo Negro"
				]
			...
			{
				"text": `Desde los pozos, expecificamente desde Pozo Negro a Estribo Duarte son como máximo 2 horas.`,
				"sub_text": []
			},
			{
				"text": `Bajariamos por el Sector de Estribo Duarte`,
				"sub_text": []
			},
			{
				"text": `Y caminariamos un tramo de la cota mil para llegar al Marques, donde los participantes pueden optar por la opción de irse en camioneta que los lleva a los Dos Caminos.
				`,
				"sub_text": []
			},
			{
			...
			{
				"text": `Si no se va a los pozos, entonces el regreso va ser por donde vinimos, bajaremos por toda la Av. Sucre hasta el metro de Los Dos Caminos.
				`,
				"sub_text": []
			}
      ],
      ...
      "important_information": [
         {
			...
			{
				"text": `Ruta con dificultad media.`,
				"sub_text": []
			},
      ],
      "prohibited": [
      ...
      "terms_and_conditions": [
         {
			...
			{
				"text": `Cumplir cada una de las recomendaciones, prohibiciones dadas para la actividad.s`,
				"sub_text": []
			},
			{
				"text": `Datos que debe suministrar: Nombres, Apellidos, N- cédula, un número de contacto de familiar o persona cercana (Solo será usado en caso de emergencia).
   ...
   },
   {
      ...
      "main_information": {
			...
			"start_date": new Date(2024, 6, 20, 8, 0, 0, 0),// [13/07/2024  8:00 a.m],
			"end_date": new Date(2024, 6, 20, 18, 0, 0, 0),//[13/07/2024  8:00 a.m]
			"meeting_point": "Plaza Francia de Altamira"
		},
      "itinerary": [
         {
				"text": `Desde plaza Francia se toma transporte público el cual esta como entre 15bs a 20bs`,
				"sub_text": []
			},
			{
				"text": `Desde donde nos deja el transporte accedemos por el sector Sabas Nieves.`,
				"sub_text": []
			},
			{
				"text": `De Sabas Nieves 1 a Sabas Nieves 2 son como máximo 1 hora.`,
				"sub_text": []
			},
			{
				"text": `De Sabas Nieves 2 a El Banquito son como máximo 1 hora y 30 minutos.`,
				"sub_text": []
			},
			{
				"text": `Del Banquito al Refugio No te Apures son como máximo 50 minutos.`,
				"sub_text": []
			},
			{
				"text": `Del Banquito a la Silla de Caracas son como máximo 1 hora y 30 minutos.`,
				"sub_text": []
			},
			{
				"text": `De la Silla de Caracas a Lagunazo son como máximo 2 horas.`,
				"sub_text": []
			},
			{
				"text": `De Lagunazo hasta el Hotel Humboldt son como máximo 2 horas.`,
				"sub_text": []
			},
			{
				"text": `Desde el Hotel Humboldt se baja en teleférico gratis por ser senderistas, igualmente llevar como 12$ por el costo de la bajada por si acaso, y desde Mariperez se toma una camioneta hasta la estación Colegio de Ingenieros o Bellas Artes.
				`,
				"sub_text": []
			},
         {
      ...
      "climate_and_vegetation": {
			...
			"vegetation": [
				{
					"text": `Estaremos la gran parte de la ruta protegidos de los rayos del sol por árboles.`,
					"sub_text": []
				},
				{
					"text": `Caminos de tierra con algunos tramos con roca suelta, tierra resbalidiza y tramos angostos cerca de acantilados.
					`,
					"sub_text": []
				},
				{
					"text": `Tramos con rocas muy altas, raices grandes y resbaladizas.`,
					"sub_text": []
				},
				{
					"text": `Llegaremos a un clima de subparamo en la zona más alta de la ruta.`,
					"sub_text": []
				}
         ]
		},
      "places_to_visit": [
         {
			...
			{
				"text": `Refugio No te Apures.`,
				"sub_text": []
			},
			{
				"text": `La Silla de Caracas.`,
				"sub_text": []
			},
			{
				"text": `Piedras Flotantes.`,
				"sub_text": []
			},
			{
				"text": `Pico Occidental.`,
				"sub_text": []
			},
			{
				"text": `Lagunazo.`,
      ...
      "feeding": [
         {
			...
			{
				"text": `Lleve agua entre 2 litros a 4 litros.`,
				"sub_text": []
			},
      ],
      "important_information": [
